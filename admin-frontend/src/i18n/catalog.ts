export const catalogMessages = {
  he: {
    ...
    preparation: 'מחירי הקטלוג מיועדים להכנת רכישות Tranzila. הסליקה עדיין אינה פעילה. מחירי PayPal הקיימים אינם מתעדכנים מכאן.',
  ...
  en: {
    ...
    preparation: 'Catalog prices prepare purchases for Tranzila. Payment processing is not yet active. Existing PayPal prices are not updated here.',
